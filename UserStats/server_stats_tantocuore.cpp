...
static const char *TantoCuore_GameName = "tantocuore";
...
static void TantoCuore_OnReportGameResult(unsigned int gameID, int playerCount, unsigned int *pResults, unsigned int *pFactions)
{
   /*
...
#endif
*/
   const char *gameName = TantoCuore_GameName;
...
bool OnRequestUserProfileStats_TantoCuore(UserStatsMainThread *pUserStats, U32 connectionId, U32 gatewayId, unsigned int profileUserId )
{
   ...
   response->gameType = GameProductId_TANTOCUORE;
...
void TantoCuore_StatsPluginInit( StatsPlugin *pluginData, MYSQL *mysqlStats )
{
   ...
   pluginData->pGameName = TantoCuore_GameName;
   ...
   pluginData->onRequestUserProfileStats = OnRequestUserProfileStats_TantoCuore;
