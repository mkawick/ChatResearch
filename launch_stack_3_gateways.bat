...
start C:\projects\Mber\ServerStack\Debug/GatewayServer.exe listen.port=9600 chat.address=localhost chat.port=7400 login.port=7600 server.name="Gateway1" asset.block=true balancer.port=9502 chat.port=7400 print.packets=false games=[localhost:21000:summon_war,192.168.1.1:21100:MFM] 
start C:\projects\Mber\ServerStack\Debug/GatewayServer.exe listen.port=9610 chat.address=localhost chat.port=7400 login.port=7600 server.name="Gateway2" asset.block=true balancer.port=9502 chat.port=7400 print.packets=false games=[localhost:21000:summon_war,192.168.1.1:21100:MFM] 
