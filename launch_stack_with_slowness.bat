...
start ./debug/LoginServer.exe listen.address=127.0.0.1 listen.port=3072 db.address=10.16.4.44 db.port=3306 db.username=incinerator db.password=Cm8235 db.schema=playdek game.port=24604 contact.port=9802 asset.port=10002
...
start ./debug/AssetDeliveryServer.exe listen.address=127.0.0.1 listen.port=9700 db.address=10.16.4.44 db.port=3306 db.username=incinerator db.password=Cm8235 db.schema=playdek game.port=24604 
