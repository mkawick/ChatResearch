...
CREATE TABLE `summonwar_event_players` (
  ...
  CONSTRAINT `summonwar_event_players_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `summonwar_event_players_ibfk_2` FOREIGN KEY (`event_id`) REFERENCES `summonwar_events` (`event_id`) ON DELETE CASCADE ON UPDATE NO ACTION
