...
--
-- Table structure for table `players_agricola`
--

DROP TABLE IF EXISTS `players_agricola`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `players_agricola` (
  ...
  KEY `user_id` (`user_id`),
  KEY `game_id` (`game_id`),
  CONSTRAINT `players_agricola_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `players_agricola_ibfk_2` FOREIGN KEY (`game_id`) REFERENCES `games_agricola` (`game_id`) ON DELETE CASCADE ON UPDATE NO ACTION
