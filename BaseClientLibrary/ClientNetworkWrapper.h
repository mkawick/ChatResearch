...
public:
   ...
   bool     RequestUserProfileStats( unsigned int profileUserId, U8 gameType = GameProductId_SUMMONWAR );
   bool     RequestGameProfile( unsigned int profileUserId, unsigned int requestUserId, U8 gameType = GameProductId_SUMMONWAR );
   bool     RequestGamePlayerFactionStats( unsigned int userId, U8 gameType = GameProductId_SUMMONWAR );
   bool     RequestGameGlobalFactionStats( U8 gameType = GameProductId_SUMMONWAR );
