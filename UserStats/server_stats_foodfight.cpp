...
static const char *Foodfight_GameName = "foodfight";
...
static void Foodfight_OnReportGameResult(unsigned int gameID, int playerCount, unsigned int *pResults, unsigned int *pFactions)
{
   /*
...
#endif
*/
   const char *gameName = Foodfight_GameName;
...
bool OnRequestUserProfileStats_Foodfight(UserStatsMainThread *pUserStats, U32 connectionId, U32 gatewayId, unsigned int profileUserId )
{
   ...
   response->gameType = GameProductId_FOODFIGHT;
...
void Foodfight_StatsPluginInit( StatsPlugin *pluginData, MYSQL *mysqlStats )
{
   ...
   pluginData->pGameName = Foodfight_GameName;
   ...
   pluginData->onRequestUserProfileStats = OnRequestUserProfileStats_Foodfight;
