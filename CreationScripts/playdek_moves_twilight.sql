...
--
-- Table structure for table `moves_twilight`
--

DROP TABLE IF EXISTS `moves_twilight`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `moves_twilight` (
  ...
  KEY `game_id` (`game_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `moves_twilight_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `games_twilight` (`game_id`) ON DELETE CASCADE,
  CONSTRAINT `moves_twilight_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION
