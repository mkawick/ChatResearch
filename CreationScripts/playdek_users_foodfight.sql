...
--
-- Table structure for table `users_foodfight`
--

DROP TABLE IF EXISTS `users_foodfight`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `users_foodfight` (
  `user_id` int(11) unsigned NOT NULL,
  `user_avatar` int(11) unsigned NOT NULL DEFAULT '1',
  `user_rating` int(11) unsigned NOT NULL DEFAULT '1000',
  PRIMARY KEY (`user_id`),
  CONSTRAINT `users_foodfight_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
