...
string  ErrorCodeLookup::GetString( int id )
{
   switch( id )
   {
      ...
      case PacketErrorReport::ErrorType_Purchase_BadPurchaseId:                        return string( "Purchase_BadPurchaseId" );
      case PacketErrorReport::ErrorType_Purchase_StoreBusy:                            return string( "Purchase_StoreBusy" );
      case PacketErrorReport::ErrorType_Purchase_UserDoesNotHaveEnoughToTrade:         return string( "Purchase_UserDoesNotHaveEnoughToTrade" );
      case PacketErrorReport::ErrorType_Purchase_UserInventoryIsFull:                  return string( "Purchase_UserInventoryIsFull" );
      case PacketErrorReport::ErrorType_Purchase_ItemNotAvailable:                     return string( "Purchase_ItemNotAvailable" );
      case PacketErrorReport::ErrorType_Purchase_TimePeriodHasNotBegunYet:             return string( "Purchase_TimePeriodHasNotBegunYet" );
      case PacketErrorReport::ErrorType_Purchase_TimePeriodHasExpired:                 return string( "Purchase_TimePeriodHasExpired" );
      case PacketErrorReport::ErrorType_Purchase_UserCannotPurchaseAnyMoreOfThese:     return string( "Purchase_UserCannotPurchaseAnyMoreOfThese" );
      case PacketErrorReport::ErrorType_Purchase_AllPurchasingIsClosedRightNow:        return string( "Purchase_AllPurchasingIsClosedRightNow" );
      case PacketErrorReport::ErrorType_Purchase_Success:                              return string( "Purchase_Success" );
