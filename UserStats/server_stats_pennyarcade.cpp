...
static const char *PennyArcade_GameName = "pennyarcade";
...
static void PennyAracde_OnReportGameResult(unsigned int gameID, int playerCount, unsigned int *pResults, unsigned int *pFactions)
{
   /*
...
#endif
*/
   const char *gameName = PennyArcade_GameName;
...
bool OnRequestUserProfileStats_PennyArcade(UserStatsMainThread *pUserStats, U32 connectionId, U32 gatewayId, unsigned int profileUserId )
{
   ...
   response->gameType = GameProductId_PENNYARCADE;
...
void PennyArcade_StatsPluginInit( StatsPlugin *pluginData, MYSQL *mysqlStats )
{
   ...
   pluginData->pGameName = PennyArcade_GameName;
   ...
   pluginData->onRequestUserProfileStats = OnRequestUserProfileStats_PennyArcade;
