...
--
-- Table structure for table `stats_foodfight`
--

DROP TABLE IF EXISTS `stats_foodfight`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stats_foodfight` (
  ...
  PRIMARY KEY (`user_id`),
  CONSTRAINT `stats_foodfight_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE NO ACTION
