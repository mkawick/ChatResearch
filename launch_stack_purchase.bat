...
start ./debug/GatewayServer.exe listen.port=9600 chat.address=127.0.0.1 chat.port=9601 login.port=3072 login.address=localhost asset.address=localhost asset.port=9700 purchase.port=9900 purchase.address=localhost print.packets=true
