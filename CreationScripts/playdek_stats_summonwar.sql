...
--
-- Table structure for table `stats_summonwar`
--

DROP TABLE IF EXISTS `stats_summonwar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stats_summonwar` (
  ...
  PRIMARY KEY (`user_id`),
  CONSTRAINT `stats_summonwar_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE NO ACTION
