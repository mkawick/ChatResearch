...
static const char *Ascension_GameName = "ascension";
...
static void Ascension_OnReportGameResult(unsigned int gameID, int playerCount, unsigned int *pResults, unsigned int *pFactions)
{
   /*
...
#endif
*/
   const char *gameName = Ascension_GameName;
...
bool OnRequestUserProfileStats_Ascension(UserStatsMainThread *pUserStats, U32 connectionId, U32 gatewayId, unsigned int profileUserId )
{
   ...
   response->gameType = GameProductId_ASCENSION;
...
void Ascension_StatsPluginInit( StatsPlugin *pluginData, MYSQL *mysqlStats )
{
   ...
   pluginData->pGameName = Ascension_GameName;
   ...
   pluginData->onRequestUserProfileStats = OnRequestUserProfileStats_Ascension;
