...
--
-- Table structure for table `user_join_chat_channel`
--

DROP TABLE IF EXISTS `user_join_chat_channel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_join_chat_channel` (
  `user_uuid` varchar(16) NOT NULL,
  `channel_uuid` varchar(16) NOT NULL,
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `added_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `date_last_viewed` datetime DEFAULT '2011-01-10 00:00:00',
  PRIMARY KEY (`id`)
