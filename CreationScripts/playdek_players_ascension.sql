...
--
-- Table structure for table `players_ascension`
--

DROP TABLE IF EXISTS `players_ascension`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `players_ascension` (
  ...
  KEY `user_id` (`user_id`),
  KEY `game_id` (`game_id`),
  CONSTRAINT `game_id` FOREIGN KEY (`game_id`) REFERENCES `games_ascension` (`game_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
