...
--
-- Table structure for table `matchmaking_agricola`
--

DROP TABLE IF EXISTS `matchmaking_agricola`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `matchmaking_agricola` (
  ...
  `created_game_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`match_id`),
  KEY `user_id` (`user_id`),
  KEY `created_game_id` (`created_game_id`)
