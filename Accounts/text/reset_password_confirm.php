...
<html>
<title>Playdek Games Reset Account Password Confirm</title>
	<script>
...
.style14 {font-family: Geneva, Arial, Helvetica, sans-serif; font-size: 14px; }
</style>
      ...
      <table Table border=0 cellspacing=0 cellpadding=0 width=893 >
        ...
        <tr>
          ...
          <td width=768 bgcolor="#EEEEEE" class="style9" >
			...
			<div >
					<table width="95%" border="0" align="center" class="style10">
					  <tr>
							<td align="center" class="style14">
						
								 Invalid Password Reset. Your password reset key may be expired. Please try again.
								<br>
								</br>
								<a href=http://accounts.playdekgames.com/reset_password.php>Link to Reset Password</a>								
								<br>
								</br>
							</td>
					  </tr>
