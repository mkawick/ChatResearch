...
--
-- Table structure for table `stats_summonwar_faction_wins`
--

DROP TABLE IF EXISTS `stats_summonwar_faction_wins`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stats_summonwar_faction_wins` (
  ...
  CONSTRAINT `stats_summonwar_faction_wins_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
