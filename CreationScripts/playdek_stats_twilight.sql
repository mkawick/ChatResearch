...
--
-- Table structure for table `stats_twilight`
--

DROP TABLE IF EXISTS `stats_twilight`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stats_twilight` (
  ...
  PRIMARY KEY (`user_id`),
  CONSTRAINT `stats_twilight_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE NO ACTION
