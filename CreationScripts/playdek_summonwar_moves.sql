...
CREATE TABLE `summonwar_moves` (
  ...
  KEY `user_id` (`user_id`),
  KEY `game_id` (`game_id`),
  CONSTRAINT `summonwar_moves_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `summonwar_moves_ibfk_2` FOREIGN KEY (`game_id`) REFERENCES `games_summonwar` (`game_id`) ON DELETE CASCADE ON UPDATE NO ACTION
